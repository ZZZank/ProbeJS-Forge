                        ...
                        .executes(context -> {
                            try {
                                ...
                                context
                                    .getSource()
                                    .sendSuccess(
                                        new TextComponent("KubeJS registry snippets generated."),
                                        false
                                    );
                            ...
                            context
                                .getSource()
                                .sendSuccess(new TextComponent("ProbeJS typing generation finished."), false);
                    ...
                    Commands
                        ...
                        .executes(context -> {
                            ...
                            if (!Files.exists(path)) {
                                context
                                    .getSource()
                                    .sendSuccess(new TextComponent("No cached files to be cleared."), false);
                                return Command.SINGLE_SUCCESS;
                            }
                            ...
                            if (deleted) {
                                context
                                    .getSource()
                                    .sendSuccess(new TextComponent("Cache files removed."), false);
                            } else {
                                context
                                    .getSource()
                                    .sendSuccess(new TextComponent("Failed to remove cache files."), false);
                            }
                            return Command.SINGLE_SUCCESS;
                        })
                )
