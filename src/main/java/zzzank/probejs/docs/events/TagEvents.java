...
public class TagEvents extends ProbeJSPlugin {
    ...
    public static final ClassPath TAG_EVENT = ClassPath.fromJavaPath("zzzank.probejs.generated.TagEventProbe");
    public static final ClassPath TAG_WRAPPER = ClassPath.fromJavaPath("zzzank.probejs.generated.TagWrapperProbe");
