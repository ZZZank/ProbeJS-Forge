...
//import dev.latvian.kubejs.block.MapColorHelper;

import dev.latvian.kubejs.block.BlockStatePredicate;
//import dev.latvian.kubejs.core.PlayerSelector;
//import dev.latvian.kubejs.item.ItemTintFunction;
//import dev.latvian.kubejs.level.gen.filter.mob.MobFilter;
//import dev.latvian.kubejs.recipe.ReplacementMatch;
//import dev.latvian.kubejs.util.NotificationBuilder;
...
public class WorldTypes extends ProbeJSPlugin {
    ...
    public void assignType(ScriptDump scriptDump) {
        ...
        scriptDump.assignType(
            RuleTest.class,
            Types.ignoreContext(Types.type(BlockStatePredicate.class), BaseType.FormatType.RETURN)
        );
